...
const WelcomeAuth = () => {
    return (
        <View style={{alignItems: 'center', justifyContent: 'center', backgroundColor: colors.background, flex: 1}}>
            ...
            <ActionButton desc="Silahkan Masuk, jika anda sudah memiliki akun" titleBtn="Masuk" />
            <ActionButton desc="atau silahkan Daftar jika anda belum memiliki akun" titleBtn="Daftar" />
        </View>
    )
}
